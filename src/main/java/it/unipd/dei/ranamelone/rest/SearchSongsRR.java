...
import it.unipd.dei.ranamelone.dao.SearchSongsDAO;
...
public class SearchSongsRR extends AbstractRR {
    /**
     * Creates a new REST resource for searching.
     * > GET rest/songs/search/{string}
     *
     * @param req    the HTTP request.
     * @param res    the HTTP response.
     * @param con    the connection to the database.
     */
    public SearchSongsRR(final HttpServletRequest req, final HttpServletResponse res, Connection con) {
    ...
    protected void doServe() throws IOException {
        ...
        try {
            ...
            objs = new SearchSongsDAO(con, search).access().getOutputParam();
