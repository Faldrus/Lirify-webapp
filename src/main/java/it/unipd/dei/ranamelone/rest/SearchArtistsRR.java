...
import it.unipd.dei.ranamelone.dao.SearchArtistsDAO;
...
public class SearchArtistsRR extends AbstractRR {
    /**
     * Creates a new REST resource for searching.
     * > GET rest/artists/search/{string}
     *
     * @param req    the HTTP request.
     * @param res    the HTTP response.
     * @param con    the connection to the database.
     */
    public SearchArtistsRR(final HttpServletRequest req, final HttpServletResponse res, Connection con) {
        super(Actions.SEARCH, req, res, con);
    }

    @Override
    protected void doServe() throws IOException {
        List<Artists> objs = null;
        Message m = null;
        ...
        try {
            ...
            objs = new SearchArtistsDAO(con, search).access().getOutputParam();
